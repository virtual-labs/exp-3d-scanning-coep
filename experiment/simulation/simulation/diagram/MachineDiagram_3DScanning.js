function MachineDrawing_3DScanning(){
...
//black box start
 ...
 /// rod 2 start      
   ...
   paper.path("M"+(x + 55)+","+(y + 45)+"l 70 -8 50 0").attr({
    ...
    paper.image('simulation/images/3dScanning model.jpg', (x + 200), (y + 180), 200, 60);
    
    //Image of cad model
    txt1 = paper.text((x + 1000), (y - 160), "3D scanned sample of model").attr({
		stroke : 'black',
		'font-size' : 30,
		"font-family": "sans-serif" 
	});    
    cadmodelImg = paper.image('simulation/images/3Dscanmodel.PNG', (x + 800), (y - 140), 600, 200);
   // cadmodelImg1 = paper.image('simulation/images/3dimg1.PNG', (x + 800), (y + 80), 600, 200);   
    
       
    tollpathImg = paper.image('simulation/images/3dimg1.PNG', (x + 800), (y + 150), 600, 200);
...
function drawCuttingTool(x,y,ax, ay, bx, by, color){
    ...
    // backrectangle.toBack();
     ...
     paper.rect((X_coOrdinate ), (Y_coOrdinate - 110), 4, 25).attr({
	    ...
	    var path = [["M", 150, 280], ["C", ax, ay, bx, by, (X_coOrdinate + 2), (Y_coOrdinate - 161)]]
    
	    discattr = {"fill": "black"};
	    wireJoint1_ToMachine = paper.circle(150, 280, 5).attr(discattr)
...
function startCutting(x, y){
	 ...
	 line.attr({
	   ...
	   setTimeout(stopcutting, 1*60*1000);
...
function stopcutting(){
   ...
   // txt2.hide();
    ...
    txt3 = paper.text((x + 1020), (y + 10), "Final 3D Model obtained from Modela Machine").attr({
		stroke : 'black',
		'font-size' : 30,
		"font-family": "sans-serif" 
	});    
    finalProduct = paper.image('simulation/images/final3D1.PNG', (x + 800), (y +  80), 600, 200);
